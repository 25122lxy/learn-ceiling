        ...
        "items": [
          {
            ...
            "items": [
              ...
              {
                "text": "生产者和消费者",
                "link": "/handbook/Learn/RabbitMQ/2.RabbitMQ-生产者和消费者"
              },
              {
                "text": "抽取工具类",
                "link": "/handbook/Learn/RabbitMQ/3.RabbitMQ-抽取工具类"
              },
              {
                "text": "轮询分发消息",
                "link": "/handbook/Learn/RabbitMQ/4.RabbitMQ-轮询分发消息"
              },
              {
                "text": "消息应答",
                "link": "/handbook/Learn/RabbitMQ/5.RabbitMQ-消息应答"
              },
              {
                "text": "持久化",
                "link": "/handbook/Learn/RabbitMQ/6.RabbitMQ-持久化"
              },
              {
                "text": "不公平分发&预取值",
                "link": "/handbook/Learn/RabbitMQ/7.RabbitMQ-不公平分发&预取值"
              },
              {
                "text": "发布确认",
                "link": "/handbook/Learn/RabbitMQ/8.RabbitMQ-发布确认"
              },
              {
                "text": "交换机",
                "link": "/handbook/Learn/RabbitMQ/9.RabbitMQ-交换机"
              },
              {
                "text": "死信队列",
                "link": "/handbook/Learn/RabbitMQ/10.RabbitMQ-死信队列"
              },
              {
                "text": "延迟队列",
                "link": "/handbook/Learn/RabbitMQ/11.RabbitMQ-延迟队列"
              }
            ]
          }
        ]
