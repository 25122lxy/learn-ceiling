...
### <font color=00dd00>5.为什么索引结构默认使用B+Tree，而不是B-Tree，Hash，二叉树，红黑树</font>
...
### <font color=00dd00>6.讲一讲聚簇索引（聚集索引）与非聚簇索引（二级索引）？</font>
...
### <font color=00dd00>什么是回表</font>

回表是和聚簇索引、非聚簇索引是有关系的，回表的 意思就是通过二级索引找到对应的主键值，然后再通过主键值找到聚集索引 中所对应的整行数据，这个过程就是回表

### <font color=00dd00>什么是覆盖索引</font>
...
### <font color=00dd00>20.MySQL支持哪些存储引擎?</font>
...
### <font color=00dd00>22.SQL约束有哪几种？</font>
...
### <font color=00dd00>23.MySQL中的varchar和char有什么区别？</font>
...
### <font color=00dd00>25.drop、delete与truncate的区别</font>
...
### <font color=00dd00>27.MySQL执行查询的过程</font>
...
### <font color=00dd00>57.超大分页怎么处理?</font>
